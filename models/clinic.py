...
class ClinicResources:
    ...
    def __init__(
        ...
        self.registration = simpy.Resource(env, capacity = 3)
        ...
        self.cashier = simpy.Resource(env, capacity = 2)
        self.pharmacy = simpy.Resource(env, capacity = 5)
        self.medicine_pickup = simpy.Resource(env, capacity = 2)
