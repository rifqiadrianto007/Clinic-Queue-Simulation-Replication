"""Experiment execution for comparing clinic queue scenarios.

This module runs all defined scenarios, averages the replication results, and
saves the final comparison table for reporting.
"""
...
def summarize_replications(
    ...
    """Calculate mean metric values for one scenario."""
...
def run_experiment() -> pd.DataFrame:
    """Run all scenarios and return the final experiment results DataFrame."""
